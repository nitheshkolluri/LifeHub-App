      ...
      <div className="relative w-full max-w-sm bg-white/80 backdrop-blur-2xl rounded-[40px] shadow-2xl overflow-hidden flex flex-col max-h-[85vh] animate-scale-in border border-white/50">
        ...
        <div className="relative h-48 shrink-0 overflow-hidden">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center pt-4 z-10 pointer-events-none">
             <div className={`avatar-blob w-24 h-24 flex items-center justify-center shadow-2xl mb-3 ${
                user?.isPremium ? 'bg-gradient-to-tr from-amber-300 to-orange-500 text-white' : 'bg-gradient-to-tr from-indigo-500 to-purple-600 text-white'
             }`}>
          ...
          {!showNotifSettings ? (
            <>
              ...
              <div className="space-y-3">
                 ...
                 <div className="w-full bg-slate-50 p-4 rounded-[20px] flex items-center justify-between opacity-60">
                    <div className="flex items-center gap-4">
                       <div className="w-10 h-10 rounded-xl bg-slate-200 text-slate-500 flex items-center justify-center">
                          <CreditCard size={20} />
                       </div>
                       <div className="text-left">
                          <p className="font-bold text-slate-600">Subscription</p>
                          <p className="text-xs text-slate-400 font-medium">Manage Pro plan</p>
                       </div>
                    </div>
                    <span className="text-[10px] font-bold bg-slate-200 text-slate-500 px-2 py-1 rounded">SOON</span>
                 </div>
              </div>
